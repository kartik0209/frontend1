...
const SignupPublisher = () => {
  ...
  const handleSubmit = useCallback(async (values, { setSubmitting, setFieldError }) => {
    try {
      ...
      await authAPI.signupPublisher(signupData);
      toast.success("Publisher account created successfully! Please login.");
      navigate("/");
    } catch (errMsg) {
      toast.error(errMsg);
    ...
    <div className="signup-container">
      ...
      <aside className="signup-leftside">
        <div className="welcome">
          <h1 className="title">
            Join as Publisher <br />
            {brandDisplay} 👋
          </h1>
          <p className="summary">
            Create your publisher account at {brandDisplay}.
            <br />
            Start earning by promoting campaigns and tracking your performance.
          </p>
        </div>
      </aside>
      ...
      <main className="form-area">
        <div className="form-wrap">
          ...
          <h2 className="heading">Sign Up as Publisher</h2>
            ...
            {({ isSubmitting, errors, touched, values }) => (
              <Form className="form" noValidate>
                ...
                <button
                  ...
                  aria-label={loading ? "Creating account..." : "Create Publisher Account"}
                >
