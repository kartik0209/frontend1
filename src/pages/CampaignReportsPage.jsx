...
const ConversionReportsPage = () => {
  ...
  const buildPublisherAdvertiserQuery = (
    publisherIds,
    advertiserIds,
  ...
  const getTableColumns = () => {
    const baseColumns = [
      ...
      },
      {
        ...
        render: (value) => value || "N/A",
        sorter: (a, b) =>
          (parseInt(a.campaignId) || 0) - (parseInt(b.campaignId) || 0),
        width: 100,
        style: { fontSize: "12px" },
      },
    ];
    ...
    baseColumns.push(
      ...
      },
      {
        ...
        sorter: (a, b) => {
          const aVal = [a.city, a.region, a.country]
            .filter(Boolean)
            .join(", ")
            .toLowerCase();
          const bVal = [b.city, b.region, b.country]
            .filter(Boolean)
            .join(", ")
            .toLowerCase();
          return aVal.localeCompare(bVal);
      ...
      },
      {
        ...
        dataIndex: "referrer",
        key: "referrer",
        render: (referrer) => referrer || "N/A",
        sorter: (a, b) => {
          const aVal = (a.referrer || "").toString().toLowerCase();
          const bVal = (b.referrer || "").toString().toLowerCase();
          return aVal.localeCompare(bVal);
        },
        width: 150,
        style: { fontSize: "12px" },
      ...
      },
      {
        ...
        sorter: (a, b) => {
          const aVal = [a.p1, a.p2, a.p3, a.p4]
            .filter(Boolean)
            .join(", ")
            .toLowerCase();
          const bVal = [b.p1, b.p2, b.p3, b.p4]
            .filter(Boolean)
            .join(", ")
            .toLowerCase();
          return aVal.localeCompare(bVal);
